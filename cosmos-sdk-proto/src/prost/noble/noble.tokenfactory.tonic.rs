...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::QueryParamsResponse>, tonic::Status>
        {
            ...
            let path = http::uri::PathAndQuery::from_static("/noble.tokenfactory.Query/Params");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("noble.tokenfactory.Query", "Params"));
        ...
        ) -> std::result::Result<tonic::Response<super::QueryGetBlacklistedResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/noble.tokenfactory.Query/Blacklisted");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("noble.tokenfactory.Query", "Blacklisted"));
            self.inner.unary(req, path, codec).await
        }
        ...
        ) -> std::result::Result<tonic::Response<super::QueryAllBlacklistedResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/noble.tokenfactory.Query/BlacklistedAll");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "noble.tokenfactory.Query",
                "BlacklistedAll",
            ));
            self.inner.unary(req, path, codec).await
        }
        ...
        ) -> std::result::Result<tonic::Response<super::QueryGetPausedResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/noble.tokenfactory.Query/Paused");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("noble.tokenfactory.Query", "Paused"));
            self.inner.unary(req, path, codec).await
        }
        ...
        ) -> std::result::Result<tonic::Response<super::QueryGetMasterMinterResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/noble.tokenfactory.Query/MasterMinter");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("noble.tokenfactory.Query", "MasterMinter"));
            self.inner.unary(req, path, codec).await
        }
        ...
        ) -> std::result::Result<tonic::Response<super::QueryGetMintersResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/noble.tokenfactory.Query/Minters");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("noble.tokenfactory.Query", "Minters"));
            self.inner.unary(req, path, codec).await
        }
        ...
        ) -> std::result::Result<tonic::Response<super::QueryAllMintersResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/noble.tokenfactory.Query/MintersAll");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("noble.tokenfactory.Query", "MintersAll"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn pauser(
            &mut self,
        ...
        ) -> std::result::Result<tonic::Response<super::QueryGetPauserResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/noble.tokenfactory.Query/Pauser");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("noble.tokenfactory.Query", "Pauser"));
            self.inner.unary(req, path, codec).await
        }
        ...
        ) -> std::result::Result<tonic::Response<super::QueryGetBlacklisterResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/noble.tokenfactory.Query/Blacklister");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("noble.tokenfactory.Query", "Blacklister"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn owner(
            &mut self,
        ...
        ) -> std::result::Result<tonic::Response<super::QueryGetOwnerResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/noble.tokenfactory.Query/Owner");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("noble.tokenfactory.Query", "Owner"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/noble.tokenfactory.Query/MinterController");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "noble.tokenfactory.Query",
                "MinterController",
        ...
        ) -> std::result::Result<tonic::Response<super::QueryGetMintingDenomResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/noble.tokenfactory.Query/MintingDenom");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("noble.tokenfactory.Query", "MintingDenom"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::MsgUpdateMasterMinterResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/noble.tokenfactory.Msg/UpdateMasterMinter");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "noble.tokenfactory.Msg",
                "UpdateMasterMinter",
            ));
            self.inner.unary(req, path, codec).await
        }
        ...
        ) -> std::result::Result<tonic::Response<super::MsgUpdatePauserResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/noble.tokenfactory.Msg/UpdatePauser");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("noble.tokenfactory.Msg", "UpdatePauser"));
            self.inner.unary(req, path, codec).await
        }
        ...
        ) -> std::result::Result<tonic::Response<super::MsgUpdateBlacklisterResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/noble.tokenfactory.Msg/UpdateBlacklister");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "noble.tokenfactory.Msg",
                "UpdateBlacklister",
        ...
        ) -> std::result::Result<tonic::Response<super::MsgUpdateOwnerResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/noble.tokenfactory.Msg/UpdateOwner");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("noble.tokenfactory.Msg", "UpdateOwner"));
            self.inner.unary(req, path, codec).await
        }
        ...
        ) -> std::result::Result<tonic::Response<super::MsgAcceptOwnerResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/noble.tokenfactory.Msg/AcceptOwner");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("noble.tokenfactory.Msg", "AcceptOwner"));
            self.inner.unary(req, path, codec).await
        }
        ...
        ) -> std::result::Result<tonic::Response<super::MsgConfigureMinterResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/noble.tokenfactory.Msg/ConfigureMinter");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("noble.tokenfactory.Msg", "ConfigureMinter"));
            self.inner.unary(req, path, codec).await
        }
        ...
        ) -> std::result::Result<tonic::Response<super::MsgRemoveMinterResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/noble.tokenfactory.Msg/RemoveMinter");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("noble.tokenfactory.Msg", "RemoveMinter"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn mint(
            &mut self,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/noble.tokenfactory.Msg/Mint");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("noble.tokenfactory.Msg", "Mint"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn burn(
            &mut self,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/noble.tokenfactory.Msg/Burn");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("noble.tokenfactory.Msg", "Burn"));
            self.inner.unary(req, path, codec).await
        }
        ...
        ) -> std::result::Result<tonic::Response<super::MsgBlacklistResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/noble.tokenfactory.Msg/Blacklist");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("noble.tokenfactory.Msg", "Blacklist"));
            self.inner.unary(req, path, codec).await
        }
        ...
        ) -> std::result::Result<tonic::Response<super::MsgUnblacklistResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/noble.tokenfactory.Msg/Unblacklist");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("noble.tokenfactory.Msg", "Unblacklist"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn pause(
            &mut self,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/noble.tokenfactory.Msg/Pause");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("noble.tokenfactory.Msg", "Pause"));
            self.inner.unary(req, path, codec).await
        }
        ...
        ) -> std::result::Result<tonic::Response<super::MsgUnpauseResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/noble.tokenfactory.Msg/Unpause");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("noble.tokenfactory.Msg", "Unpause"));
            self.inner.unary(req, path, codec).await
        }
